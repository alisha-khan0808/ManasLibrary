...
export function InvoiceDocument({
  ...
  return (
    <article className="print-keep-color mx-auto w-full max-w-[820px] bg-white p-8 text-[13px] leading-relaxed text-slate-900 print:p-0">
      {/* ---------------------------------------------------------------
      ...
      <header className="flex flex-wrap items-start justify-between gap-6">
        ...
        <div className="shrink-0 text-right">
          <p className="text-3xl font-bold tracking-tight text-slate-400">INVOICE</p>
      ...
      {/* ---------------------------------------------------------------
          Footer.
          --------------------------------------------------------------- */}
      <footer className="print-avoid-break mt-10 border-t border-slate-300 pt-4 text-center text-[11px] text-slate-600">
        <p>
...
function Th({ children, className = '' }: { children?: React.ReactNode; className?: string }) {
  return (
    <th
      scope="col"
      className={`px-2 py-1.5 text-[11px] font-semibold uppercase tracking-wider ${className}`}
    >
      {children}
    </th>
  );
